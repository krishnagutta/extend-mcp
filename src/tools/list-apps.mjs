...
export function register(server) {
  server.tool(
    'list_extend_apps',
    'List all Workday Extend apps for the Lyft organization. Returns app names, referenceIds, status, and latest version info. Use referenceId for all other app commands.',
    {
